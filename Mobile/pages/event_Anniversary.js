...
import { checkIsLogin, redirectToLogin, redirectToDeposit, retryCall, numberWithCommas } from '@/lib/js/util';
import HostConfig from '@/server/Host.config';
import ReactIMG from '@/components/View/ReactIMG';
import Ann14BubbleGif from '@/components/Events/ann14BubbleGif';
...
const prizeNameMap = { P1: '免费彩金', P3: '乐币', P4: '周年大惊喜', P5: '没有奖励' };
...
export default class ann14 extends Component {
	...
	needLogin = () => {
		if (!checkIsLogin()) {
			redirectToLogin('?from=event_Anniversary');
			return true;
		}
		return false;
	};
	...
	showMyPrizes = async () => {
		...
		// Pushgtagdata('Engagement_Event', 'View', 'MyPrize_14thAnniversary');
	...
	afterOpenPrizePopup = () => {
		...
		//增加 ?日期數字 用來強制加載動畫
		const imgUrl =
			`${process.env.BASE_PATH}` + '/img/events/ann14/Popping/Pop-Up-Prize-BG.gif' + '?' + new Date().getTime();
	...
	drawPrize = async (clickBubble = true) => {
		...
		if (clickBubble) {
			// Pushgtagdata('Engagement_Event', 'Claim', 'GrabLuckyGift_14thAnniversary');
		} else {
			// Pushgtagdata('Engagement_Event', 'Click', 'GrabMore_14thAnniversary');
		}
	...
	clickDeposit = () => {
		// Pushgtagdata('Deposit_Nav', 'Click', 'Deposit_14thAnniversary');
		redirectToDeposit();
	};
			...
			>
				<div className="ann14-container">
					<div className="ann14-top">
						<ReactIMG className="ann14-top-banner" src="/img/events/ann14/Title-CN.webp" />
						<div className="ann14-top-text-container">
							<div className="ann14-top-text">6月18日至6月20日 FUN肆迎战</div>
						</div>
						...
						<div className="ann14-top-portals-container">
							...
							/>
							<Ann14BubbleGif
								className="ann14-top-portal ann14-top-portal-5"
								gifClassName="ann14-top-portal-gif ann14-top-portal-gif-5"
								gifClick={() => this.drawPrize()}
								noGif={noGifStatus}
							/>
							<Ann14BubbleGif
								className="ann14-top-portal ann14-top-portal-6"
								gifClassName="ann14-top-portal-gif ann14-top-portal-gif-6"
								gifClick={() => this.drawPrize()}
								noGif={noGifStatus}
							/>
						</div>
						...
						>
							...
							<div className="ann14-top-popup-content">
								<div className="ann14-top-popup-desc">
									...
									{hintType == 5 ? (
										<React.Fragment>
											很遗憾您的奖励是空的，请再接再厉！ <br />今天剩余 {remainingGrabFromCurrentTier} 次参与活动的机会
										</React.Fragment>
									) : null}
									{hintType == 6 ? (
										<React.Fragment>
											很遗憾您的奖励是空的，请再接再厉！ <br />您参与活动的次数已用完，请存款后再试。
										</React.Fragment>
									) : null}
									{hintType == 7 ? (
										<React.Fragment>
											很遗憾您的奖励是空的，请再接再厉！ <br />您今日参与活动的次数已用完，请明天再试
										</React.Fragment>
									) : null}
									{hintType == 8 ? (
								...
								<div className="ann14-top-popup-buttons">
									{hintType == 1 || hintType == 2 || hintType == 4 || hintType == 6 ? (
										<React.Fragment>
											<div
												className="ann14-top-popup-button-blue"
												onClick={() => this.setState({ showHint: false })}
											>
												返回
											</div>
							...
							{this.state.showPrizeResult ? (
								<div className="ann14-prize-popup-content">
									...
									<ReactIMG
										...
										src={'/img/events/ann14/Prizes/CN/CN_' + this.state.prizeType + '.webp'}
									/>
					...
					<div className="ann14-middle">
						...
						<div className="ann14-middle-steps-container">
							<div className="ann14-middle-step ann14-middle-step1">
								<ReactIMG className="ann14-middle-step-img" src="/img/events/ann14/Icon-1.webp" />
							...
							<div className="ann14-middle-step ann14-middle-step2">
								<ReactIMG className="ann14-middle-step-img" src="/img/events/ann14/Icon-2.webp" />
							...
							<div className="ann14-middle-step ann14-middle-step3">
								<ReactIMG className="ann14-middle-step-img" src="/img/events/ann14/Icon-3.webp" />
								<div className="ann14-middle-step-title-1">步骤三</div>
								<div className="ann14-middle-step-title-2">FUN肆迎战夺奖励!</div>
							</div>
						</div>
						<div className="ann14-middle-button-container">
							<div
								...
								onClick={() => {
									// Pushgtagdata('Engagement_Event', 'View', 'TnC_14thAnniversary');
						...
						>
							...
							<div className="ann14-middle-popup-content">
								1. 此活动开放给所有乐天堂会员<br />
								活动时间： 2022年6月18日 00:00:01 至2022年6月20日 23:59:59。 (北京时间）<br />
								<br />
								2. 参加方式:<br />
								...
								<br />
								例:<br />
								会员于6月18日完成第一笔300元存款，即刻获取一次游戏机会。会员其后再存款2,700元，当日总存款累积至3,000元，便可进行剩余的游戏次数。<br />
								<br />
								<br />
								- 会员点击跳出的“游戏产品”以激活奖品。<br />
								- 未进行的游戏次数不会累计至次日。<br />
								<br />
								3. 此活动将以乐币, 免费彩金与周年大惊喜为奖品。<br />
								<br />
								4. 派彩时间：<br />
								免费彩金（主钱包）：得奖后30分钟内。<br />
								乐币（天王俱乐部）：得奖后30分钟内。<br />
								周年大惊喜（礼品）：确认收货信息之后的30天内。<br />
								<br />
								5. 乐币：<br />
					...
					<div className="ann14-bottom">
						<div className="ann14-bottom-title-container">
							<div className="ann14-bottom-title">活动奖品</div>
						</div>
							...
							{prizeList.map((pn) => {
								return (
									<ReactIMG
										...
										src={'/img/events/ann14/Prizes/CN/CN_' + pn + '.webp'}
									/>
								);
							})}
						</div>
