...
import { _extends } from '$SBTWOLIB/js/util'
    ...
    var closePromise = new Promise(function (resolve) {
        ...
        getMessageInstance(function (instance) {
            ...
            instance.notice({
                ...
                }, React.createElement("div", null, args.icon ? args.icon : switchIconNode, /*#__PURE__*/React.createElement("span", null, args.type === "loading" && args.content === undefined ? "加载中,请稍后..." : args.content))),
                onClose: callback
            });
        }, isLoading);
    });
