 ...
 * @LastEditors: Alan
 * @LastEditTime: 2022-06-28 00:51:19
 * @Description: 抽屉组件
 * @FilePath: \Mobile\src\components\View\Drawer\index.js
 */
...
export default class Drawer extends React.Component {
    ...
    changeDrawer (status, isClear) {
        ...
        const isModalExist = !!document.querySelector(".modal")
        ...
        if (status) {
            ...
            if (isClear) {
                body.setAttribute("style", isModalExist ? "overflow-y: hidden" : "");
