...
class SecondStep extends React.Component {
    ...
    goThirdStep = e => {
        ...
        // Pushgtagdata("Depositsuccess_OASmilepay_deposit");
      }
    goBackStep = (e) => {
        e && typeof e !== "string" && e.preventDefault();

        this.props.setLbStep(1);
        // Pushgtagdata("Close_onlinealipay_deposit");
        // e !== "notClear" && this.props.form.resetFields();
    };
    copySuccessCall() {
        Toast.info("已复制");
        // Pushgtagdata("Copy_onlinealipay_deposit");
    }
    render() {
        const { res } = this.props.resultData;
        //console.log(res);
                        ...
                        <Fragment>
                            <ul>
                                ...
                                >
                                    ...
                                    <QRCode size={160} value={res.DeepLink} />
                                </li>
                                ...
                                <li className="item-wrap">
                                    ...
                                    <div className="input-info-message">请务必于支付宝App交易页面填写备注代码​</div>
                                </li>
                            </ul>
                        </Fragment>
                    ) : null}
...
export default createForm({ fieldNameProp: "OAsecondstep" })(SecondStep);
